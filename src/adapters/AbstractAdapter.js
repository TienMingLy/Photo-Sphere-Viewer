...
export class AbstractAdapter extends AbstractService {
   ...
   */
  loadTexture(panorama, newPanoData) { // eslint-disable no-unused-vars
   ...
   */
  createMesh(scale = 1) { // eslint-disable no-unused-vars
   ...
   */
  setTexture(mesh, textureData) { // eslint-disable no-unused-vars
   ...
   */
  setTextureOpacity(mesh, opacity) { // eslint-disable no-unused-vars
